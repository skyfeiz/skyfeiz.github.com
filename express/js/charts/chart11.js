...
(function () {
    ...
    var dataArr = [
        {name: 'Galaxy S7', value: 10000},
        {name: '魅族 Note6', value: 9000},
        {name: 'iPhone 8', value: 8000},
        {name: '荣耀 畅玩6X', value: 7000},
        {name: '红米 Note5A', value: 6000},
    ];
    var columnW = 70, columnH = 450;

    var Chart11 = function (scene, resourcesMap) {
        this.scene = scene;
        this.resourcesMap = resourcesMap;
        this.init();
    }

    var p = Chart11.prototype;
    ...
    p.createTitle = function () {
        ...
        obj['context'].fillText('仓储出货排行', 150, 32);
        ...
        obj['context'].clearRect(0, 0, 300, 64);
        obj['context'].fillText('RANKING LIST OF SALES', 150, 32);
        obj['material'].map.needsUpdate = true;
        subTitle.position.y = -35;
    ...
    p.createColumns = function () {
        ...
        this.datas.map(function (item, index) {
            ...
            nameItem.position.x = (columnW + 40) * index - 225;
